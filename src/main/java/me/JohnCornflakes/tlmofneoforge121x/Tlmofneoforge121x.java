package me.JohnCornflakes.tlmofneoforge121x;
...
@Mod(Tlmofneoforge121x.MODID)
public class Tlmofneoforge121x {
    // Define mod id in a common place for everything to reference
    public static final String MODID = "tlmofneoforge121x";
    ...
    public Tlmofneoforge121x(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (Tlmofneoforge121x) to respond directly to events.
    ...
    private static void onEntityDamaged(LivingIncomingDamageEvent event) {
        ...
        Entity dmgSourceEnt = dmgSource.getEntity();
